...
class XheBaseDom extends XheBaseObject
{
	...
	protected function z_click_by_number($number,$frame,$wait_browser)
	{
   	...
   	// click by id
	protected function z_click_by_id($id,$exactly,$frame,$wait_browser)
	{
   	...
   	// click by value
	protected function z_click_by_value($value,$exactly,$frame,$wait_browser)
	{
	...
	protected function z_click_by_href($href,$exactly,$frame,$wait_browser)
	{
	...
	// click by alt
	protected function z_click_by_alt($alt,$exactly,$frame,$wait_browser)
	{
	...
	// click by src
	protected function z_click_by_src($src,$exactly,$frame,$wait_browser)
	{
	...
	protected function z_click_by_inner_text($inner_text,$exactly,$frame,$wait_browser)
	{
	...
	protected function z_click_by_inner_html($inner_html,$exactly,$frame,$wait_browser)	{
	...
	protected function z_click_by_attribute($attr_name,$attr_value,$exactly,$frame,$wait_browser)
	{
	...
	protected function z_click_by_name_by_form_number($name,$form_number,$frame,$wait_browser)
	{
        ...
        // click by number in form by name (��� ����� �������� : ���������� �� �������)
	protected function z_click_by_number_by_form_name($number,$form_name,$frame,$wait_browser)
	{
        ...
        // click by number in form by number (��� ����� �������� : ���������� �� �������)
	...
	protected function z_set_focus_by_inner_text($inner_text,$exactly,$frame)
	{
		$this->wait_element_exist_by_inner_text($inner_text,$exactly,$frame);
	...
	protected function z_set_focus_by_inner_html($inner_html,$exactly,$frame)
	{
		$this->wait_element_exist_by_inner_html($inner_html,$exactly,$frame);
	...
	protected function z_set_focus_by_href($href,$exactly,$frame)
	{
		$this->wait_element_exist_by_attribute("href",$href,$exactly,$frame);
	...
	protected function z_set_focus_by_attribute($attr_name,$attr_value,$exactly,$frame)
	{
		$this->wait_element_exist_by_attribute($attr_name,$attr_value,$exactly,$frame);
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        // set value by number in form by form name (��� ����� �������� : ���������� �� �������)
        ...
        // set value by number in form by form number (��� ����� �������� : ���������� �� �������)
	...
	// is element exist by outer html (��� ����� �������� : ���������� �� �������)
	...
	protected function z_get_number_by_inner_text($inner_text,$exactly,$frame)
	{
		$this->wait_element_exist_by_inner_text($inner_text,$exactly,$frame);
	...
	protected function z_get_number_by_inner_html($inner_html,$exactly,$frame)
	{
		$this->wait_element_exist_by_inner_html($inner_html,$exactly,$frame);
	...
	protected function z_get_number_by_id($id,$frame)
	{
   	...
   	// get number by src
	protected function z_get_number_by_src($src,$exactly,$frame)
	{
		$this->wait_element_exist_by_attribute("src",$src,$exactly,$frame);
   	...
   	// get number by href
	protected function z_get_number_by_href($href,$exactly,$frame)
	{
		$this->wait_element_exist_by_attribute("href",$href,$exactly,$frame);
        ...
        protected function z_get_number_by_attribute($attr_name,$attr_value,$exactly,$frame)
        {
		$this->wait_element_exist_by_attribute($attr_name,$attr_value,$exactly,$frame);
	...
	protected function z_get_inner_text_by_attribute($attr_name,$attr_value,$exactly,$frame)
        {
		$this->wait_element_exist_by_attribute($attr_name,$attr_value,$exactly,$frame);
	...
	protected function z_get_inner_html_by_attribute($attr_name,$attr_value,$exactly,$frame)
        {
		$this->wait_element_exist_by_attribute($attr_name,$attr_value,$exactly,$frame);
	...
	protected function z_get_href_by_inner_text($inner_text,$exactly,$frame)
	{
		$this->wait_element_exist_by_inner_text($inner_text,$exactly,$frame);
	...
	protected function z_get_all_inner_texts($separator,$text_filter,$frame=-1)
	{
        ...
        // get inner texts of all elements on page by href (��� ����� �������� : ���������� �� �������)
	...
	// get all inner htmls by inner text (��� ����� �������� : ���������� �� �������)
	...
	// get all attribute values by inner text (��� ����� �������� : ���������� �� �������)
	...
	// get all inner text by attribute (��� ����� �������� : ���������� �� �������)
	...
	// get all inner htmls by attribute (��� ����� �������� : ���������� �� �������)
	...
	// get all attribute values by attribute (��� ����� �������� : ���������� �� �������)
