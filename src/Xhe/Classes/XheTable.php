...
class XheTable extends XheTableCompatible
{
	...
	// получить количество ячеек таблицы по ее номеру
	...
	function get_cols_by_number($number,$frame=-1,$row=0)
	{
        ...
        // получить текст заданной ячейки (по столбцу и строке) в таблице с заданным номеру
	...
	// получить текст заданной ячейки (по позиции) в таблице с заданным номером
	...
	// получить x координату ячейки (по строке и столбцу) у таблицы с заданным номером
	...
	// получить x координату ячейки (по строке и столбцу) у таблицы с заданным внутренним текстом
	...
	// получить x координату ячейки (по строке и столбцу) у таблицы с заданным значением аттрибута
	function get_cell_x_by_attribute($attr_name,$attr_value,$exactly,$row,$col,$frame=-1)
	{
        ...
        // получить y координату ячейки (по строке и столбцу) у таблицы с заданным номером
	...
	// получить y координату ячейки (по строке и столбцу) у таблицы с заданным внутренним текстом
	...
	// получить y координату ячейки (по строке и столбцу) у таблицы с заданным значением аттрибута
