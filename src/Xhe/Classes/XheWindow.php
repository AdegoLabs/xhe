...
class XheWindow extends XheWindowCompatible
{
	...
	// задать текст в полее ввода текста дочернего окна программы и нажать OK
	...
	// получить список интерфейсов окон по ID потока
	...
	// получить список интерфейсов окон по ID процесса
	...
	// ожидать пока окно с заданным текстом не откроется
	...
	// ожидать пока окно с заданным класом не откроется
	...
	// ожидать пока окно с заданным текстом не закроется
	...
	// ожидать пока окно с заданным класом не закроется
